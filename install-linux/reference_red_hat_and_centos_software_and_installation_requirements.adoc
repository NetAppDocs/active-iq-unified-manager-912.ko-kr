...
* x86_64 아키텍처 기반의 Red Hat Enterprise Linux 버전 7.x 및 8.0 ~ 8.6.
...
* MySQL Community Edition 버전 8.0.30(MySQL 리포지토리에서).
* OpenJDK 버전 11.0.17(Red Hat Extra Enterprise Linux Server 리포지토리에서)
* Python 3.6.x
